...
class Simulator:
    ...
    - Если текущее заданное перемещение оказывается дольше, чем времение ло следующего измерения, 
    ...
    - Нейронной сети на вход передаются не просто координаты текущего положения станка, а история их изменения длиной move_history_len.
    """
