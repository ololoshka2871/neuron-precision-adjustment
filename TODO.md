...
[_] Поэтапное введение оценок в симуляцию, добавлять каждые 200 поколений
    [_] Оценивать только изменение частоты
    [_] добавить штраф за попадание в запрещенную зону
    [_] добавить дисбалланс
    [_] добавить самооценку
    [_] добавить штраф за перегрев
    [_] добавить бонус за скорость перемещения
    [_] добавить штраф за время работы
    [_] добавить штраф за причину остановки
