...
class ControllerGrager:
    ...
    def get_grade(self, rezonator_metrics: Metrics, sim_metrics: dict, stop_condition: StopCondition):
        ...
        Оценка:
            ...
            - 8 Бонус за среднюю мощность лазера - больше - лучше
            - 9 Оценка за причину остановки - больше - лучше
        """

        GRADE_WEIGTHS = [-100.0, -250.0, -2.5, 10.0, -0.05, 0.0, -0.05, 0.5, 0.5, 0.5]
        ...
        w = np.array([
            ...
            sim_metrics['avg_laser_power'],  # средняя мощность лазера
