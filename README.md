...
Проведены статистические исследования множества симуляций с разными параметрами. Восновном проходит удачно, но случаются ошибки и на 1Hz+,
статичтически несущественно.

Обнаружено, что на этапе грубой настройки пескоструем срезается большая часть веток с верхнего края резонатора, так что может быть срезано до 80% настроечной зоны. Придется исключить операцию подбора угра реза и увеличить базовую мощность чтобы на меленьком кусочке настроить резонатор.
Кроме того некоторые резонаторы покрыты золотом, а некоторые серебром. и настраиваться они будут, очевидно, по разному.